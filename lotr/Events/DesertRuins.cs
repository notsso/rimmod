...
namespace lotr {
    // ===== Инцидент =====
    public class IncidentWorker_DesertRuins : IncidentWorker {
        ...
        protected override bool TryExecuteWorker(IncidentParms parms) {
            ...
            SitePartDef sitePart = DefDatabase<SitePartDef>.GetNamed("DesertRuins_Site");
            ...
            WorldObjectDef siteObjectDef = DefDatabase<WorldObjectDef>.GetNamed("DesertRuins_World");
